...
if __name__ == '__main__':
    ...
    launch_time = Time('2027-01-08 00:00:00', scale='utc', location=launch_location) #'2026-12-25 00:00:00'
    
    step_hr = 3.0 * u.hr
    my_duration = 24 * 4* u.hr
    ...
    #np.linspace(270, 280,10, endpoint=True) #
    list_galactic_longitude = np.concatenate(( np.linspace(270, 358,10, endpoint=True), (0,)))
